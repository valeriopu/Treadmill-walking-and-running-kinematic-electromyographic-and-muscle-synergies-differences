function sorted_synergy_struct = cosinesimilarity_sorting_TW(muscle_synergy_struct,n_samples,n_muscles,patient)
...
% 'cosinesimilarity_sorting_TW' is a Matlab function that sorts the extracted
...
%C
sorted_synergy_struct.P0007.C = zeros(n_opt_mode_W,n_samples);
sorted_synergy_struct.P0007.C(1,:) = muscle_synergy_struct.P0007(4).C(1,:);
sorted_synergy_struct.P0007.C(3,:) = muscle_synergy_struct.P0007(4).C(2,:);
sorted_synergy_struct.P0007.C(4,:) = muscle_synergy_struct.P0007(4).C(4,:);
sorted_synergy_struct.P0007.C(2,:) = muscle_synergy_struct.P0007(4).C(3,:);
%W
sorted_synergy_struct.P0007.W = zeros(n_muscles,n_opt_mode_W);
sorted_synergy_struct.P0007.W(:,1) = muscle_synergy_struct.P0007(4).W(:,1);
sorted_synergy_struct.P0007.W(:,3) = muscle_synergy_struct.P0007(4).W(:,2);
sorted_synergy_struct.P0007.W(:,4) = muscle_synergy_struct.P0007(4).W(:,4);
sorted_synergy_struct.P0007.W(:,2) = muscle_synergy_struct.P0007(4).W(:,3);
...
% P0005 - Walking
sorted_synergy_struct.P0005.C([1,3],:) = sorted_synergy_struct.P0005.C([3,1],:);
sorted_synergy_struct.P0005.W(:,[1,3]) = sorted_synergy_struct.P0005.W(:,[3,1]);
% P0009 - Walking
sorted_synergy_struct.P0009.C([1,3],:) = sorted_synergy_struct.P0009.C([3,1],:);
sorted_synergy_struct.P0009.W(:,[1,3]) = sorted_synergy_struct.P0009.W(:,[3,1]);
% P0023 - Walking
sorted_synergy_struct.P0023.C([1,3],:) = sorted_synergy_struct.P0023.C([3,1],:);
sorted_synergy_struct.P0023.W(:,[1,3]) = sorted_synergy_struct.P0023.W(:,[3,1]);    
